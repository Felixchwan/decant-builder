...
describe("buildCollectionSummary", () => {
  ...
  it("summarizes one perfume below both readiness minimums", () => {
    ...
    expect(summary.coverageSummary.strengths).toEqual([
      { category: "occasions", target: "daily", label: "Daily Covered", count: 1 },
      { category: "occasions", target: "office", label: "Office Covered", count: 1 },
      { category: "occasions", target: "casual", label: "Casual Covered", count: 1 },
      { category: "seasons", target: "spring", label: "Spring Covered", count: 10 },
      { category: "seasons", target: "summer", label: "Summer Covered", count: 8 },
      { category: "vibes", target: "fresh", label: "Fresh Covered", count: 1 },
      { category: "vibes", target: "clean", label: "Clean Covered", count: 1 },
      { category: "vibes", target: "versatile", label: "Versatile Covered", count: 1 },
    ]);
  ...
  it("composes coverage counts, ordering, labels, and seasonal recommendation fallbacks", () => {
    ...
    expect(summary.coverageSummary.strengths).toEqual([
      { category: "occasions", target: "daily", label: "Daily Covered", count: 2 },
      { category: "occasions", target: "office", label: "Office Covered", count: 2 },
      { category: "occasions", target: "casual", label: "Casual Covered", count: 1 },
      { category: "occasions", target: "date", label: "Date Covered", count: 1 },
      { category: "occasions", target: "night", label: "Night Covered", count: 1 },
      { category: "occasions", target: "formal", label: "Formal Covered", count: 1 },
      { category: "seasons", target: "spring", label: "Strong Spring Coverage", count: 16 },
      { category: "seasons", target: "summer", label: "Summer Covered", count: 8 },
      { category: "seasons", target: "fall", label: "Strong Fall Coverage", count: 16 },
      { category: "seasons", target: "winter", label: "Winter Covered", count: 12 },
      { category: "vibes", target: "fresh", label: "Fresh Covered", count: 1 },
      { category: "vibes", target: "clean", label: "Clean Covered", count: 2 },
      { category: "vibes", target: "versatile", label: "Versatile Covered", count: 1 },
      { category: "vibes", target: "elegant", label: "Elegant Covered", count: 1 },
      { category: "vibes", target: "bold", label: "Bold Covered", count: 1 },
      { category: "vibes", target: "seductive", label: "Seductive Covered", count: 1 },
    ]);
  ...
  it("summarizes a realistic golden fixture with exact collection outputs", () => {
    ...
    expect(summary.coverageSummary.strengths).toEqual([
      { category: "occasions", target: "daily", label: "Strong Daily Coverage", count: 4 },
      { category: "occasions", target: "office", label: "Strong Office Coverage", count: 4 },
      { category: "occasions", target: "casual", label: "Strong Casual Coverage", count: 4 },
      { category: "occasions", target: "date", label: "Date Covered", count: 2 },
      { category: "occasions", target: "night", label: "Night Covered", count: 2 },
      { category: "occasions", target: "formal", label: "Strong Formal Coverage", count: 3 },
      { category: "seasons", target: "spring", label: "Strong Spring Coverage", count: 32 },
      { category: "seasons", target: "summer", label: "Strong Summer Coverage", count: 35 },
      { category: "seasons", target: "fall", label: "Strong Fall Coverage", count: 34 },
      { category: "seasons", target: "winter", label: "Strong Winter Coverage", count: 29 },
      { category: "vibes", target: "fresh", label: "Strong Fresh Coverage", count: 4 },
      { category: "vibes", target: "clean", label: "Strong Clean Coverage", count: 4 },
      { category: "vibes", target: "versatile", label: "Versatile Covered", count: 1 },
      { category: "vibes", target: "elegant", label: "Elegant Covered", count: 2 },
      { category: "vibes", target: "bold", label: "Bold Covered", count: 2 },
      { category: "vibes", target: "seductive", label: "Seductive Covered", count: 2 },
    ]);
    expect(summary.coverageSummary.gaps).toEqual([]);
    expect(dnaFrom(summary)).toEqual({
