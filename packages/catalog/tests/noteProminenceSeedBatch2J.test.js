...
const PHASE_2J_BATCH = {
  302: { grapefruit: 7, whiteMusk: 6, amber: 5, cedarwood: 4 }, // Phase 3C: added cedarwood (horizontal calibration)
  ...
  406: { pineapple: 8, oakmoss: 8, cedar: 4, patchouli: 4 }, // Phase 3C: cedar 5 -> 4 (horizontal calibration)
...
const PHASE_2C_BATCH = {
  ...
  404: { apple: 9, lavender: 9, vanilla: 7, cardamom: 4, coumarin: 4 }, // Phase 3J: lavender 8 -> 9 (horizontal calibration) // Phase 3B: apple 8 -> 9 (horizontal calibration)
