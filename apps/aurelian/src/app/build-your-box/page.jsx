...
export default function BuilderPage() {
  return <section className="builder-page"><header className="page-shell page-intro page-intro--compact"><p className="eyebrow">Tu Discovery Box</p><h1>Elige 6–14 fragancias.</h1><p className="lede">Explora el catálogo, alcanza un mínimo de 12 puntos y solicita por WhatsApp una revisión de disponibilidad. Aurelian confirmará antes de compartir instrucciones de pago.</p><Link className="text-link" href="/como-funciona">Revisar cómo funciona</Link></header><BuilderMount isDevelopment={process.env.NODE_ENV === "development"} /></section>;
}
