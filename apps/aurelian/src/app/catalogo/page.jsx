...
export default function CatalogPage() {
  return <section className="page-shell page-intro catalog-page"><p className="eyebrow">84 fragancias para explorar</p><h1>Encuentra los aromas que quieres conocer.</h1><p className="lede">Busca por fragancia o casa. Cada valor en puntos forma parte de la composición de tu Discovery Box y no representa el precio de una botella.</p><CatalogExplorer /></section>;
}
