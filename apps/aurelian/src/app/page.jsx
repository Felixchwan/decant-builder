...
export default function HomePage() {
  return (
    <>
      <section className="aurelian-hero page-shell"><div className="aurelian-hero__copy"><p className="eyebrow">Aurelian · Perfumería para descubrir</p><h1>Aprende a reconocer qué fragancias son realmente para ti.</h1><p className="lede">Antes de una botella completa, compara con calma. No seguimos tendencias ni dejamos que lo más vendido decida por ti: cada Discovery Box es un punto de partida para construir tu propio criterio.</p><div className="button-row"><Link className="button" href="/build-your-box">Construye tu Discovery Box</Link><Link className="text-link" href="/como-funciona">Entiende el concepto</Link></div></div><HeroMedia /></section>
      ...
      <section className="section page-shell"><p className="eyebrow">Nuestro sesgo declarado</p><h2 className="display-heading">No estamos aquí para vender más. Estamos aquí para ayudarte a distinguir lo que de verdad es tuyo.</h2><p className="section-lede">No priorizamos por margen ni por lo que más se vende. Priorizamos ayudarte a construir tu propio criterio — aunque eso signifique que, con el tiempo, compres menos.</p></section>
      <section className="section section--surface"><div className="page-shell"><p className="eyebrow">Cómo funciona</p><h2 className="display-heading">De la curiosidad a una selección propia.</h2><div className="steps steps--three"><article><h3><span>01</span>Explora</h3><p>Conoce las {aurelianCatalog.length} fragancias del catálogo y su valor en puntos.</p></article><article><h3><span>02</span>Construye</h3><p>Selecciona 6–14 fragancias y alcanza el mínimo de 12 puntos.</p></article><article><h3><span>03</span>Confirma</h3><p>Aurelian revisa disponibilidad y después comparte las instrucciones de pago.</p></article></div></div></section>
