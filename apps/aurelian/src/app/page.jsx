...
export default function HomePage() {
  return (
    <>
      ...
      <section className="section page-shell"><div className="section-heading"><div><p className="eyebrow">Selección destacada</p><h2>Un vistazo al catálogo</h2></div><Link className="text-link" href="/catalogo">Ver las 84 fragancias</Link></div><p className="section-lede">No son las fragancias “mejor valoradas”: son un punto de partida distinto en cada estación.</p><SeasonalFeaturedSelection /></section>
